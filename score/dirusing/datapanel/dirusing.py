...
def datapanel(context, main=None, session=None):
    ...
    <datapanel>
      <tab id="1" name="Редактирование данных">
        ...
        <element id="11" type="xforms" template="dirusing_filter.xml" proc="dirusing.xforms.dirfilter.cardData.celesta"> 
          <related id="13"/>
        </element>
        ...
        <element id="16" type="xforms" template="directory_data_del_card.xml" proc="dirusing.xforms.dircontentdelcard.cardDelData.celesta" neverShowInPanel="true">
          <proc id="proc16" name="dirusing.xforms.dircontentdelcard.cardDelDataSave.celesta" type="SAVE"/>
          <related id="13"/>
        </element>
        <element id="17" type="xforms" template="directory_data_del_all_card.xml" proc="dirusing.xforms.dircontentdelcard.cardDelData.celesta" neverShowInPanel="true">
